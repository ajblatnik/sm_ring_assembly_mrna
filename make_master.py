#paste into command line: python3 make_master.py -f $PWD -o master_table -d (make folder with all featurecount .tsv and run this script in this directory)
import os
import sys
import glob
import argparse
...
class create_table() : 
    ...
    def merge_to_annotation(self) : 
        ...
        if self._annotation is not None : 
            ...
            self._df.to_csv(f"{self._outprefix}.txt", header = True, index = False, sep = "\t")
